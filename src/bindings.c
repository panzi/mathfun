...
bool mathfun_context_define_default(mathfun_context *ctx, mathfun_error_p *error) {
	const mathfun_decl decls[] = {
		...
		// Functions. TODO: native wrappers for missing functions
		{ MATHFUN_DECL_FUNCT, "isnan",          { .funct = { mathfun_funct_isnan,          &mathfun_bsig1, NULL } } },
		{ MATHFUN_DECL_FUNCT, "isfinite",       { .funct = { mathfun_funct_isfinite,       &mathfun_bsig1, NULL } } },
		{ MATHFUN_DECL_FUNCT, "isnormal",       { .funct = { mathfun_funct_isnormal,       &mathfun_bsig1, NULL } } },
		{ MATHFUN_DECL_FUNCT, "isinf",          { .funct = { mathfun_funct_isinf,          &mathfun_bsig1, NULL } } },
		{ MATHFUN_DECL_FUNCT, "isgreater",      { .funct = { mathfun_funct_isgreater,      &mathfun_bsig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "isgreaterequal", { .funct = { mathfun_funct_isgreaterequal, &mathfun_bsig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "isless",         { .funct = { mathfun_funct_isless,         &mathfun_bsig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "islessequal",    { .funct = { mathfun_funct_islessequal,    &mathfun_bsig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "islessgreater",  { .funct = { mathfun_funct_islessgreater,  &mathfun_bsig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "isunordered",    { .funct = { mathfun_funct_isunordered,    &mathfun_bsig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "signbit",        { .funct = { mathfun_funct_signbit,        &mathfun_bsig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "acos",           { .funct = { mathfun_funct_acos,           &mathfun_sig1, (mathfun_native_funct)acos } } },
		{ MATHFUN_DECL_FUNCT, "acosh",          { .funct = { mathfun_funct_acosh,          &mathfun_sig1, (mathfun_native_funct)acosh } } },
		{ MATHFUN_DECL_FUNCT, "asin",           { .funct = { mathfun_funct_asin,           &mathfun_sig1, (mathfun_native_funct)asin } } },
		{ MATHFUN_DECL_FUNCT, "asinh",          { .funct = { mathfun_funct_asinh,          &mathfun_sig1, (mathfun_native_funct)asinh } } },
		{ MATHFUN_DECL_FUNCT, "atan",           { .funct = { mathfun_funct_atan,           &mathfun_sig1, (mathfun_native_funct)atan } } },
		{ MATHFUN_DECL_FUNCT, "atan2",          { .funct = { mathfun_funct_atan2,          &mathfun_sig2, (mathfun_native_funct)atan2 } } },
		{ MATHFUN_DECL_FUNCT, "atanh",          { .funct = { mathfun_funct_atanh,          &mathfun_sig1, (mathfun_native_funct)atanh } } },
		{ MATHFUN_DECL_FUNCT, "cbrt",           { .funct = { mathfun_funct_cbrt,           &mathfun_sig1, (mathfun_native_funct)cbrt } } },
		{ MATHFUN_DECL_FUNCT, "ceil",           { .funct = { mathfun_funct_ceil,           &mathfun_sig1, (mathfun_native_funct)ceil } } },
		{ MATHFUN_DECL_FUNCT, "copysign",       { .funct = { mathfun_funct_copysign,       &mathfun_sig2, (mathfun_native_funct)copysign } } },
		{ MATHFUN_DECL_FUNCT, "cos",            { .funct = { mathfun_funct_cos,            &mathfun_sig1, (mathfun_native_funct)cos } } },
		{ MATHFUN_DECL_FUNCT, "cosh",           { .funct = { mathfun_funct_cosh,           &mathfun_sig1, (mathfun_native_funct)cosh } } },
		{ MATHFUN_DECL_FUNCT, "erf",            { .funct = { mathfun_funct_erf,            &mathfun_sig1, (mathfun_native_funct)erf } } },
		{ MATHFUN_DECL_FUNCT, "erfc",           { .funct = { mathfun_funct_erfc,           &mathfun_sig1, (mathfun_native_funct)erfc } } },
		{ MATHFUN_DECL_FUNCT, "exp",            { .funct = { mathfun_funct_exp,            &mathfun_sig1, (mathfun_native_funct)exp } } },
		{ MATHFUN_DECL_FUNCT, "exp2",           { .funct = { mathfun_funct_exp2,           &mathfun_sig1, (mathfun_native_funct)exp2 } } },
		{ MATHFUN_DECL_FUNCT, "expm1",          { .funct = { mathfun_funct_expm1,          &mathfun_sig1, (mathfun_native_funct)expm1 } } },
		{ MATHFUN_DECL_FUNCT, "abs",            { .funct = { mathfun_funct_abs,            &mathfun_sig1, (mathfun_native_funct)fabs } } },
		{ MATHFUN_DECL_FUNCT, "fdim",           { .funct = { mathfun_funct_fdim,           &mathfun_sig2, (mathfun_native_funct)fdim } } },
		{ MATHFUN_DECL_FUNCT, "floor",          { .funct = { mathfun_funct_floor,          &mathfun_sig1, (mathfun_native_funct)floor } } },
		{ MATHFUN_DECL_FUNCT, "fma",            { .funct = { mathfun_funct_fma,            &mathfun_sig3, (mathfun_native_funct)fma } } },
		{ MATHFUN_DECL_FUNCT, "fmod",           { .funct = { mathfun_funct_fmod,           &mathfun_sig2, (mathfun_native_funct)fmod } } },
		{ MATHFUN_DECL_FUNCT, "max",            { .funct = { mathfun_funct_max,            &mathfun_sig2, (mathfun_native_funct)fmin } } },
		{ MATHFUN_DECL_FUNCT, "min",            { .funct = { mathfun_funct_min,            &mathfun_sig2, (mathfun_native_funct)fmax } } },
		{ MATHFUN_DECL_FUNCT, "hypot",          { .funct = { mathfun_funct_hypot,          &mathfun_sig2, (mathfun_native_funct)hypot } } },
		{ MATHFUN_DECL_FUNCT, "j0",             { .funct = { mathfun_funct_j0,             &mathfun_sig1, (mathfun_native_funct)j0 } } },
		{ MATHFUN_DECL_FUNCT, "j1",             { .funct = { mathfun_funct_j1,             &mathfun_sig1, (mathfun_native_funct)j1 } } },
		{ MATHFUN_DECL_FUNCT, "jn",             { .funct = { mathfun_funct_jn,             &mathfun_sig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "ldexp",          { .funct = { mathfun_funct_ldexp,          &mathfun_sig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "log",            { .funct = { mathfun_funct_log,            &mathfun_sig1, (mathfun_native_funct)log } } },
		{ MATHFUN_DECL_FUNCT, "log10",          { .funct = { mathfun_funct_log10,          &mathfun_sig1, (mathfun_native_funct)log10 } } },
		{ MATHFUN_DECL_FUNCT, "log1p",          { .funct = { mathfun_funct_log1p,          &mathfun_sig1, (mathfun_native_funct)log1p } } },
		{ MATHFUN_DECL_FUNCT, "log2",           { .funct = { mathfun_funct_log2,           &mathfun_sig1, (mathfun_native_funct)log2 } } },
		{ MATHFUN_DECL_FUNCT, "logb",           { .funct = { mathfun_funct_logb,           &mathfun_sig1, (mathfun_native_funct)logb } } },
		{ MATHFUN_DECL_FUNCT, "nearbyint",      { .funct = { mathfun_funct_nearbyint,      &mathfun_sig1, (mathfun_native_funct)nearbyint } } },
		{ MATHFUN_DECL_FUNCT, "nextafter",      { .funct = { mathfun_funct_nextafter,      &mathfun_sig2, (mathfun_native_funct)nextafter } } },
		{ MATHFUN_DECL_FUNCT, "nexttoward",     { .funct = { mathfun_funct_nexttoward,     &mathfun_sig2, (mathfun_native_funct)nexttoward } } },
		{ MATHFUN_DECL_FUNCT, "remainder",      { .funct = { mathfun_funct_remainder,      &mathfun_sig2, (mathfun_native_funct)remainder } } },
		{ MATHFUN_DECL_FUNCT, "round",          { .funct = { mathfun_funct_round,          &mathfun_sig1, (mathfun_native_funct)round } } },
		{ MATHFUN_DECL_FUNCT, "scalbln",        { .funct = { mathfun_funct_scalbln,        &mathfun_sig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "sin",            { .funct = { mathfun_funct_sin,            &mathfun_sig1, (mathfun_native_funct)sin } } },
		{ MATHFUN_DECL_FUNCT, "sinh",           { .funct = { mathfun_funct_sinh,           &mathfun_sig1, (mathfun_native_funct)sinh } } },
		{ MATHFUN_DECL_FUNCT, "sqrt",           { .funct = { mathfun_funct_sqrt,           &mathfun_sig1, (mathfun_native_funct)sqrt } } },
		{ MATHFUN_DECL_FUNCT, "tan",            { .funct = { mathfun_funct_tan,            &mathfun_sig1, (mathfun_native_funct)tan } } },
		{ MATHFUN_DECL_FUNCT, "tanh",           { .funct = { mathfun_funct_tanh,           &mathfun_sig1, (mathfun_native_funct)tanh } } },
		{ MATHFUN_DECL_FUNCT, "gamma",          { .funct = { mathfun_funct_gamma,          &mathfun_sig1, (mathfun_native_funct)tgamma } } },
		{ MATHFUN_DECL_FUNCT, "trunc",          { .funct = { mathfun_funct_trunc,          &mathfun_sig1, (mathfun_native_funct)trunc } } },
		{ MATHFUN_DECL_FUNCT, "y0",             { .funct = { mathfun_funct_y0,             &mathfun_sig1, (mathfun_native_funct)y0 } } },
		{ MATHFUN_DECL_FUNCT, "y1",             { .funct = { mathfun_funct_y1,             &mathfun_sig1, (mathfun_native_funct)y1 } } },
		{ MATHFUN_DECL_FUNCT, "yn",             { .funct = { mathfun_funct_yn,             &mathfun_sig2, NULL } } },
		{ MATHFUN_DECL_FUNCT, "sign",           { .funct = { mathfun_funct_sign,           &mathfun_sig1, NULL } } },
